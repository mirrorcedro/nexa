...
const Sidebar = () => {
  ...
  const filteredUsers = users
    .filter((user) => {
      // Search filter logic, safeguard against undefined or null values
      const fullName = user.fullName || "";  // Default to empty string if undefined or null
      const username = user.username || "";  // Default to empty string if undefined or null
